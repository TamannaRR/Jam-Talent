	...
	<div class="row">
		...
		<div class="col-xl-4 col-lg-4">
			<div class="sidebar-container">
				...
				@else
				<!-- <a href="{{route('login')}}" class="apply-now-button popup-with-zoom-anim">Apply Now <i class="icon-material-outline-arrow-right-alt"></i></a> -->
					@endif
					@endif
					@endif
			...
			<div class="popup-tab-content" id="tab">
				...
				<form method="POST" action="{{route('job.apply', $Job->id)}}" enctype="multipart/form-data">
					...
					<div class="uploadButton margin-top-25">
						...
						<span class="uploadButton-file-name">Upload your CV / resume relevant file. <br> Max. files size: 50 MB.</span>
					</div>
					<button class="button margin-top-35 full-width button-sliding-icon ripple-effect" type="submit">Apply Now <i class="icon-material-outline-arrow-right-alt"></i></button>
