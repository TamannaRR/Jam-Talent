					...
					<div class="bidding-widget">
						...
						<div class="bidding-inner">
							<form action="{{route('task.apply',$task->id)}}" method="POST">
								...
								<input class="bidding-slider" name="min_budget" type="text" value="" data-slider-handle="custom" data-slider-currency="$" data-slider-min="2500" data-slider-max="4500" data-slider-value="auto" data-slider-step="50" data-slider-tooltip="hide" />
								...
								<!-- Button -->
								<button id="snackbar-place-bid" class="button ripple-effect move-on-hover full-width margin-top-30" type="submit"><span>Place a Bid</span></button>
							</form>
