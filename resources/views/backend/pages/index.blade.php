					...
					<div class="dashboard-box child-box-in-row"> 
						...
						<div class="content with-padding">
							...
							<div class="add-note-button">
								<a href="#small-dialog" class="popup-with-zoom-anim button full-width button-sliding-icon" data-target="small-dialog1" >Add Note <i class="icon-material-outline-arrow-right-alt"></i></a>
							</div>
							<div id="small-dialog1" class="zoom-anim-dialog mfp-hide dialog-with-tabs">

	<!--Tabs -->
	<div class="sign-in-form">

		<ul class="popup-tabs-nav">
			<li><a href="#tab">Add Note xfd</a></li>
		</ul>
