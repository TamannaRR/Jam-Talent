									...
									<div class="row">
										...
										<div class="col-xl-6">
											<div class="submit-field">
												<h5>First Name</h5>
												<input type="text" name="first_name" class="with-border" value="{{$employer->first_name}}">
											</div>
										</div>
										...
										<div class="col-xl-6">
											<div class="submit-field">
												<h5>Last Name</h5>
												<input type="text" class="with-border" name="last_name" value="{{$employer->last_name}}">
											</div>
										</div>
										...
										<div class="col-xl-6">
											<div class="submit-field">
												<h5>Email</h5>
												<input type="text" class="with-border" value="{{$employer->email}}" name="email">
											</div>
										</div>
							...
							<li>
								<div class="row">
									<div class="col-xl-6">
										<div class="submit-field">
											<h5>Tagline</h5>
											<input type="text" class="with-border" value="{{$employer->sort_description}}" name="sort_description">
										</div>
									</div>
