	...
	<div  class="col-12 col-xl-12 col-md-12">
		...
		<table class="basic-table table-responsive">
			...
			<tr>
				...
				<td data-label="Column 2">{{$freelancer->sort_description}}</td>
				...
				<td data-label="Column 3">{{$freelancer->hourly_rate}}</td>
				<td data-label="Column 3">
					@if($freelancer->verified == 1)
					
							<form method="POST" action="{{route('freelancer.enActive',$freelancer->id)}}"enctype="multipart/form-data">
							@csrf
